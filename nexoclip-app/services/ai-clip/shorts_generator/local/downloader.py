...
def download_youtube_local(video_url: str, fmt: str = "720", out_dir: Optional[str] = None) -> str:
    ...
    ydl_opts = {
        ...
        "no_warnings": True,
        "noprogress": True,
        # The default web client 403s on YouTube's video-data URLs (YouTube's
        # anti-bot signature checks). The android client's URLs don't need
        # that signature and reliably work as of 2026.
