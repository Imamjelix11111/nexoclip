...
def _workspace_root() -> str:
    # Per-tenant data root (.vimax / .working_dir live here). The multi-tenant web
    # server sets this per user; defaults to the cwd for single-user / dev runs.
    return os.environ.get("VIMAX_WORKSPACE_ROOT") or "."
...
def load_runtime():
    ...
    return build_runtime(_workspace_root())


def load_session_index():
    from agent_runtime.session_index import SessionIndex

    return SessionIndex(_workspace_root())
