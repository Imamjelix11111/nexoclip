...
```bash
# Clone the Nexoclip monorepo
git clone https://github.com/ImamAsyariAlmaturidi/nexoclip.git
cd nexoclip/nexoclip-app

# Install dependencies + build workspace packages (studio, workflow, agents).
# ViMax/AI Storyboard lives inside services/vimax; no submodule checkout is needed.
npm run setup
