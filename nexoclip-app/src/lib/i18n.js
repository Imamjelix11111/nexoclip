...
const translations = {
    en: {
        ...
        'agents.webOnly': 'Available in the web app at nexoclip.com',

        // Workflow Studio
        'workflows.title': 'Workflow Studio',
        'workflows.webOnly': 'Available in the web app at nexoclip.com',
        ...
        'mcp.title': 'MCP & CLI',
        'mcp.subtitle': 'Use Nexoclip from your terminal, your IDE, or any MCP-compatible assistant. Generate cinematic images, videos, and audio across 100+ models — without leaving your workflow.',
    ...
    zh: {
        ...
        // Agent Studio
        'agents.title': '智能体工作室',
        'agents.webOnly': '在网页应用 nexoclip.com 上可用',

        // Workflow Studio
        'workflows.title': '工作流工作室',
        'workflows.webOnly': '在网页应用 nexoclip.com 上可用',
        ...
        'mcp.title': 'MCP & CLI',
        'mcp.subtitle': '在终端、IDE 或任何兼容 MCP 的助手中使用 Nexoclip。跨 100+ 模型生成电影级图像、视频和音频 — 无需离开您的工作流。',
        'mcp.quickStart': '快速开始',
    },
};
